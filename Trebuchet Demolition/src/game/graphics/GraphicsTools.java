...
public class GraphicsTools
{
	...
	public static final Font MAIN_FONT = new Font("Century Gothic", Font.BOLD,
			40);
	public static final Font OPTIONS_FONT = new Font("Century Gothic",
			Font.BOLD, 27);
	public static final Font SMALL_TEXT_FONT = new Font("Century Gothic",
			Font.BOLD, 15);
	public static final Font DETAIL_FONT = new Font("Century Gothic",
			Font.BOLD, 12);
	public static final Font LEVEL_SELECT_FONT = new Font("Monospaced",
			Font.BOLD, 15);
	...
	public static void drawShadowedText(Graphics g, String text, int x, int y,
			int dist)
	{
		// Draw two versions of the text, one slightly offset
	...
	public static Color brighten(Color color, double fraction)
	{
		...
		int red = (int) Math.round(Math.min(255, color.getRed() + 255
				* fraction));
		int green = (int) Math.round(Math.min(255, color.getGreen() + 255
				* fraction));
		int blue = (int) Math.round(Math.min(255, color.getBlue() + 255
				* fraction));
